    ...
    try {
      ...
      switch (err.code) {
        ...
        case 'auth/invalid-credential':
          setError('Invalid email or password. If you are not registered, please sign up first.');
          break;
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white/70 backdrop-blur-xl border border-white/40 shadow-xl rounded-2xl p-8 relative">
        ...
        <div className="mt-4">
          <h1 className="text-3xl font-bold bg-gradient-to-br from-blue-800 to-purple-600 bg-clip-text text-transparent mb-2">Welcome Back</h1>
          <p className="text-slate-500 mb-6">Sign in to continue to Internship Agent</p>
        </div>
